...
function suscribirEventosNivelesaprobados(){
    $(".itemEditarNivelesaprobados").click(function(e){
        e.preventDefault();    
        $.ajax({
            url: "/" + modulo + "/editarNivelesAprobados/" + $(this).data('id'),  // <-- AND HERE
            type: 'get',
            dataType: 'json',
...
function suscribirEventosJornadas(){
    $(".itemEditarJornada").click(function(e){
        e.preventDefault();    
        $.ajax({
            url: "/" + modulo + "/editarJornadas/" + $(this).data('id'),  // <-- AND HERE
            type: 'get',
            dataType: 'json',
            success: function (data) {
                if (data.transaccion) {                                                  
